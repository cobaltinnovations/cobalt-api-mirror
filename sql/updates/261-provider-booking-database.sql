...
-- Global feature-to-support-role mappings used by provider search filtering.
...
-- This preserves branch-local values from the earlier location-level schema
-- before removing those accidental columns.
DO $$
BEGIN
	IF EXISTS (
		SELECT 1
