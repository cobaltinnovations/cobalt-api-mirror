...
SET bio=provider_fixture.bio,
	website_url=FORMAT('https://fixtures.cobalt.care/providers/%s', COALESCE(NULLIF(provider.url_name, ''), provider.provider_id::TEXT)),
...
SET description=clinic_fixture.description,
	...
	email_address=FORMAT('clinic-%s@example.com', clinic_fixture.clinic_id),
...
UPDATE provider
SET bio_url=FORMAT('https://fixtures.cobalt.care/providers/%s/bio', fixture_provider.url_name),
	website_url=FORMAT('https://fixtures.cobalt.care/providers/%s', fixture_provider.url_name)
...
SET website_url=FORMAT('https://fixtures.cobalt.care/clinics/%s', fixture_clinic.clinic_id),
	email_address=FORMAT('clinic-%s@example.com', fixture_clinic.clinic_id)
FROM fixture_clinic
WHERE clinic.clinic_id=fixture_clinic.clinic_id;

-- Add owner-specific provider and clinic address fixtures plus institution
-- location filter fixtures. These deterministic rows exercise the production
-- location schema without leaking QA-only addresses into the functional
-- migration.
WITH fixture_provider_location AS (
	...
	FROM (VALUES
		('15f9711d-38e1-44a1-a933-f1522ddd2c81'::UUID, NULL::TEXT, 'Dr. Allen Fixture Office', 'Allen Office', 1, 'Dr. Allen Fixture Office', '4101 Fixture Provider Lane', 'Philadelphia', 'PA', '19104', '4101 Fixture Provider Lane, Philadelphia, PA 19104'),
		('31633b9d-651b-402b-9314-7def6af811b6'::UUID, NULL::TEXT, 'Dr. Spence Anxiety Clinic Office', 'Spence Office', 1, 'Dr. Spence Anxiety Clinic Office', '4102 Fixture Provider Lane', 'Philadelphia', 'PA', '19104', '4102 Fixture Provider Lane, Philadelphia, PA 19104'),
		('360d46c4-2ee9-4031-aab6-aa6a16f398d7'::UUID, NULL::TEXT, 'Dr. Fritz Therapy Office', 'Fritz Office', 1, 'Dr. Fritz Therapy Office', '4103 Fixture Provider Lane', 'Philadelphia', 'PA', '19104', '4103 Fixture Provider Lane, Philadelphia, PA 19104'),
		(NULL::UUID, 'John Skokowski', 'John Skokowski Autism Intake Office', 'Autism Intake', 1, 'John Skokowski Autism Intake Office', '4112 Fixture Provider Lane', 'Philadelphia', 'PA', '19104', '4112 Fixture Provider Lane, Philadelphia, PA 19104')
	) AS provider_location_fixture(provider_id, provider_name, name, short_name, display_order, postal_name, street_address_1, locality, region, postal_code, formatted_address)
	JOIN provider
		ON (
...
WITH fixture_provider_location AS (
	...
	FROM (VALUES
		('15f9711d-38e1-44a1-a933-f1522ddd2c81'::UUID, NULL::TEXT, 'Dr. Allen Fixture Office', 'Allen Office', 1),
		('31633b9d-651b-402b-9314-7def6af811b6'::UUID, NULL::TEXT, 'Dr. Spence Anxiety Clinic Office', 'Spence Office', 1),
		('360d46c4-2ee9-4031-aab6-aa6a16f398d7'::UUID, NULL::TEXT, 'Dr. Fritz Therapy Office', 'Fritz Office', 1),
		(NULL::UUID, 'John Skokowski', 'John Skokowski Autism Intake Office', 'Autism Intake', 1)
	) AS provider_location_fixture(provider_id, provider_name, name, short_name, display_order)
	JOIN provider
		ON (
			provider_location_fixture.provider_id IS NOT NULL
			AND provider.provider_id=provider_location_fixture.provider_id
...
WITH fixture_clinic_location AS (
	...
	FROM (VALUES
		('d789dbdb-6756-4293-836d-91b7329fb49c'::UUID, NULL::TEXT, 'Behavioral Wellness Fixture Front Desk', 'Wellness Front Desk', 1, 'Behavioral Wellness Fixture Front Desk', '4201 Fixture Clinic Avenue', 'Philadelphia', 'PA', '19107', '4201 Fixture Clinic Avenue, Philadelphia, PA 19107'),
		('b6c5e9a3-6018-473d-86d4-2861a328e537'::UUID, NULL::TEXT, 'Stress and Anxiety Fixture Front Desk', 'Anxiety Front Desk', 1, 'Stress and Anxiety Fixture Front Desk', '4202 Fixture Clinic Avenue', 'Philadelphia', 'PA', '19107', '4202 Fixture Clinic Avenue, Philadelphia, PA 19107'),
		('7872559f-b5f6-449f-892d-3f312cd691ff'::UUID, NULL::TEXT, 'Cognitive Therapy Fixture Front Desk', 'Cognitive Front Desk', 1, 'Cognitive Therapy Fixture Front Desk', '4203 Fixture Clinic Avenue', 'Philadelphia', 'PA', '19107', '4203 Fixture Clinic Avenue, Philadelphia, PA 19107'),
		('ab629384-400a-4688-8465-04636ec2eaa2'::UUID, NULL::TEXT, 'Adult Autism Services Fixture Front Desk', 'Autism Front Desk', 1, 'Adult Autism Services Fixture Front Desk', '4204 Fixture Clinic Avenue', 'Philadelphia', 'PA', '19107', '4204 Fixture Clinic Avenue, Philadelphia, PA 19107'),
		(NULL::UUID, 'Penn Autism Clinic', 'Penn Autism Clinic Fixture Intake Desk', 'Penn Autism Intake', 1, 'Penn Autism Clinic Fixture Intake Desk', '4212 Fixture Clinic Avenue', 'Philadelphia', 'PA', '19107', '4212 Fixture Clinic Avenue, Philadelphia, PA 19107')
	) AS clinic_location_fixture(clinic_id, clinic_description, name, short_name, display_order, postal_name, street_address_1, locality, region, postal_code, formatted_address)
	JOIN clinic
		ON (
...
WITH fixture_clinic_location AS (
	...
	FROM (VALUES
		('d789dbdb-6756-4293-836d-91b7329fb49c'::UUID, NULL::TEXT, 'Behavioral Wellness Fixture Front Desk', 'Wellness Front Desk', 1),
		('b6c5e9a3-6018-473d-86d4-2861a328e537'::UUID, NULL::TEXT, 'Stress and Anxiety Fixture Front Desk', 'Anxiety Front Desk', 1),
		('7872559f-b5f6-449f-892d-3f312cd691ff'::UUID, NULL::TEXT, 'Cognitive Therapy Fixture Front Desk', 'Cognitive Front Desk', 1),
		('ab629384-400a-4688-8465-04636ec2eaa2'::UUID, NULL::TEXT, 'Adult Autism Services Fixture Front Desk', 'Autism Front Desk', 1),
		(NULL::UUID, 'Penn Autism Clinic', 'Penn Autism Clinic Fixture Intake Desk', 'Penn Autism Intake', 1)
	) AS clinic_location_fixture(clinic_id, clinic_description, name, short_name, display_order)
	JOIN clinic
		ON (
			clinic_location_fixture.clinic_id IS NOT NULL
			AND clinic.clinic_id=clinic_location_fixture.clinic_id
...
WITH fixture_institution_location AS (
	...
	FROM (VALUES
		('COBALT', 'Cobalt Fixture Testing Center', 'Testing Center', 10),
		('COBALT', 'Cobalt Fixture Telehealth Hub', 'Telehealth Hub', 11),
		('COBALT_IC_SELF_REFERRAL', 'Self Referral Fixture Intake Office', 'Self Referral Intake', 1)
	) AS institution_location_fixture(institution_id, name, short_name, display_order)
	JOIN institution
