 ...
 */
@ThreadSafe
public class PageRowCustomThreeColumnApiResponse {
	@Nonnull
	...
	@Nonnull
	private final PageRowColumnApiResponse columnThree;
	@Nonnull
	...
	public interface PageCustomThreeColumnApiResponseFactory {
		@Nonnull
		PageRowCustomThreeColumnApiResponse create(@Nonnull PageRow pageRow);
	}

	@AssistedInject
	public PageRowCustomThreeColumnApiResponse(@Nonnull Formatter formatter,
