...
public class ReportType {
	...
	public enum ReportTypeId {
		...
		SIGN_IN_PAGEVIEW_NO_ACCOUNT,
		ACCOUNT_SIGNUP_UNVERIFIED,
		ACCOUNT_ONBOARDING_INCOMPLETE,
		ACCOUNT_ONBOARDING_COMPLETE,
		ACCOUNT_ONBOARDING_COMPLETE_V2,
		ACCOUNT_GEOLOCATION,
		COURSE_FEEDBACK,
		COURSE_MCB_DOWNLOAD,
		ACCOUNT_TIMELINE,

		// institution.analytics_profile_id='LEGACY'
		...
		// institution.analytics_profile_id='XRAY'
		ADMIN_ANALYTICS_ACCOUNT_VISITS,
		ADMIN_ANALYTICS_ACCOUNT_CREATION,
		ADMIN_ANALYTICS_ACCOUNT_REPEAT_VISITS,
		ADMIN_ANALYTICS_COURSE_ACCOUNT_VISITS,
		ADMIN_ANALYTICS_COURSE_AGGREGATE_VISITS, // Rollup like "10 accounts visited 1 course, 20 accounts visited 2, ..."
		ADMIN_ANALYTICS_COURSE_MODULE_ACCOUNT_VISITS,
		ADMIN_ANALYTICS_COURSE_DWELL_TIME,
		ADMIN_ANALYTICS_COURSE_MODULE_DWELL_TIME,
		ADMIN_ANALYTICS_COURSE_COMPLETION,
		ADMIN_ANALYTICS_COURSE_AGGREGATE_COMPLETIONS,
		ADMIN_ANALYTICS_COURSE_MODULE_COMPLETION,
		ADMIN_ANALYTICS_ACCOUNT_LOCATION,
		ADMIN_ANALYTICS_ACCOUNT_REFERRER,
		ADMIN_ANALYTICS_ACCOUNT_ONBOARDING_RESULTS,
	}
